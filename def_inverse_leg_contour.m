function leg_contour = def_inverse_leg_contour(hip_joint, delta_theta, delta_r)
...
%     hold on;
    ...
    half_circle_1 = def_inverse_half_circle(leg_1_center(1), leg_1_center(2), real_theta, 1);
    half_circle_2 = def_inverse_half_circle(leg_2_center(1), leg_2_center(2), real_theta + pi, 2);
