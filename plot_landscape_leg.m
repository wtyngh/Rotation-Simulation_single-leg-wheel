function plot_legend = plot_landscape_leg(landscape_table,leg_contour)
    %% plot landscape
    plot_legend.landscape = plot(landscape_table(1,:),landscape_table(2,:),'color','k' ,'linewidth', 2 );
    hold on;
    
    %% plot hip joint
    plot(leg_contour.center(1),leg_contour.center(2),'marker','o','MarkerSize',8);
    ...
    plot(leg_contour.leg_1.center(1), leg_contour.leg_1.center(2), 'marker','x','MarkerEdgeColor','b', 'MarkerSize',6);
    
    %% plot leg_2
    plot_legend.leg_2 = ...
    plot(leg_contour.leg_2.contour.x, leg_contour.leg_2.contour.y, 'color','r' ,'linewidth', 1.5);
    
    % plot from center to the first point of the contour
    plot([leg_contour.leg_2.center(1), leg_contour.leg_2.contour.x(1)],...
         [leg_contour.leg_2.center(2), leg_contour.leg_2.contour.y(1)], 'color','r','linewidth', 1.5);
    
    % plot the center of the half circle
    plot(leg_contour.leg_2.center(1), leg_contour.leg_2.center(2), 'marker','x','MarkerEdgeColor','r', 'MarkerSize',6);
