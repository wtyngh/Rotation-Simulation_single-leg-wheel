...
%          [contact_point_x, interp1(landscape_table(1,:),landscape_table(2,:),contact_point_x),min_dif_1];
     ...
     %%%%%%%% solution 2
        ...
        revise_vector_1 = (leg_contour.leg_1.center - landscape_points_1(:,j)')*(r - min_distance_1);
...
%         contact_point.point_2 = [contact_point_x, interp1(landscape_table(1,:),landscape_table(2,:),contact_point_x) ,min_dif_2];
    ...
    %%%%%%%% solution 2
        ...
        revise_vector_2 = (leg_contour.leg_2.center - landscape_points_2(:,v)')*(r - min_distance_2);
